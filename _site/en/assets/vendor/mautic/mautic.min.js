...
MauticJS.mauticInsertedScripts=MauticJS.mauticInsertedScripts||{};if("undefined"==typeof jQuery&&"undefined"==typeof MauticJS.mauticInsertedScripts.jQuery){MauticJS.insertScript('https://mautic4.cfaz.net/app/bundles/CoreBundle/Assets/js/libraries/2.jquery.js?v89d54c6b');MauticJS.mauticInsertedScripts.jQuery=true;}
if("undefined"==typeof Froogaloop&&"undefined"==typeof MauticJS.mauticInsertedScripts.Froogaloop){MauticJS.insertScript('https://mautic4.cfaz.net/app/bundles/CoreBundle/Assets/js/libraries/froogaloop2.min.js?v89d54c6b');MauticJS.mauticInsertedScripts.Froogaloop=true;}
if("undefined"==typeof jQuery||"undefined"==typeof Froogaloop){MauticJS.gatedVideoTimeoutID=window.setTimeout(MauticJS.initGatedVideo,1000);}else{MauticJS.insertStyle('https://mautic4.cfaz.net/media/css/mediaelementplayer.min.css?v89d54c6b');
/*!
 *
 * MediaElement.js
...
mediaPlayers[i]=[];if(node.dataset.formId){var cookieName='mautic-player-'+i+'-'+node.dataset.formId;MauticJS.makeCORSRequest('GET','https://mautic4.cfaz.net/form/embed/'+node.dataset.formId,{},function(data){mediaPlayers[i].formHtml=data;});}else{mediaPlayers[i].formHtml='';}
...
if(typeof events.focus_item!=='undefined'){var e=events.focus_item;for(var i=0;i<e.length;i++){if(typeof e[i]['id']!=='undefined'&&typeof e[i]['js']!=='undefined'){MauticJS.insertScript(e[i]['js']);}}}};if(typeof MauticDomain=='undefined'){var MauticDomain='https://mautic4.cfaz.net';}
...
var url='https://mautic4.cfaz.net/dwc/slotNamePlaceholder'.replace('slotNamePlaceholder',slotName);MauticJS.makeCORSRequest('GET',url,params,function(response,xhr){if(response.content){var dwcContent=response.content;node.innerHTML=dwcContent;if(response.id&&response.sid){MauticJS.setTrackedContact(response);}
if(dwcContent.search("mauticform_wrapper")>0){if(typeof MauticSDK=='undefined'){MauticJS.insertScript('https://mautic4.cfaz.net/media/js/mautic-form.js?v89d54c6b');var fileInterval=setInterval(function(){if(typeof MauticSDK!='undefined'){MauticSDK.onLoad();clearInterval(fileInterval);}},100);}else{MauticSDK.onLoad();}}
var m;var regEx=/<script[^>]+src="?([^"\s]+)"?\s/g;while(m=regEx.exec(dwcContent)){if((m[1]).search("/focus/")>0){MauticJS.insertScript(m[1]);}}
if(dwcContent.search("fr-gatedvideo")>0){MauticJS.initGatedVideo();}}});});}};MauticJS.beforeFirstEventDelivery(MauticJS.replaceDynamicContent);(function(m,l,n,d){m.pageTrackingUrl=(l.protocol=='https:'?'https:':'https:')+'//mautic4.cfaz.net/mtracking.gif';m.pageTrackingCORSUrl=(l.protocol=='https:'?'https:':'https:')+'//mautic4.cfaz.net/mtc/event';m.contactIdUrl=(l.protocol=='https:'?'https:':'http:')+'//mautic4.cfaz.net/mtc';m.getOs=function(){var OSName="Unknown OS";if(navigator.appVersion.indexOf("Win")!=-1)OSName="Windows";if(navigator.appVersion.indexOf("Mac")!=-1)OSName="MacOS";if(navigator.appVersion.indexOf("X11")!=-1)OSName="UNIX";if(navigator.appVersion.indexOf("Linux")!=-1)OSName="Linux";return OSName;}
