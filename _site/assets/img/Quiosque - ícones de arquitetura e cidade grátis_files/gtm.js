...
a.ig&&z("did",a.ig);var R=B+"/pagead/landing?"+y.join("&");oc(R)}}var c=!!a.qe,d=!!a.sa,e=a.U,f=void 0===a.hd?{}:a.hd,g=void 0===a.pd?!0:a.pd,h=ok(),l=h.gclid||"",m=h.gclsrc,p=h.dclid||"",q=h.gbraid||"",r=!c&&((!l||m&&"aw.ds"!==m?!1:!0)||q),t=Qg();if(r||t)t?jh(function(){b();fh(N.D)||ih(function(u){return b(!0,u.Rh)},N.D)},[N.D]):b()}function $n(a,b){var c=a&&!fh(N.D);return b&&c?"0":b}
var zo=function(){if(!fh(N.D)||!yo&&!un(""))return!1;yo=!0;var a=H.featurePolicy;if(a&&Ja(a.features)&&-1!==a.features().indexOf("conversion-measurement"))return!0;return!1},Ao=function(a){return!(void 0===a||null===a||0===(a+"").length)},Bo=function(a,b){var c;if(2===b.qa)return a("ord",Ra(1E11,1E13)),!0;if(3===b.qa)return a("ord","1"),a("num",Ra(1E11,
1E13)),!0;if(4===b.qa)return Ao(b.sessionId)&&a("ord",b.sessionId),!0;if(5===b.qa)c="1";else if(6===b.qa)c=b.Te;else return!1;Ao(c)&&a("qty",c);Ao(b.jd)&&a("cost",b.jd);Ao(b.transactionId)&&a("ord",b.transactionId);return!0},Eo=function(a,b,c,d){function e(Q,T,S){t.hasOwnProperty(Q)||(T=String(T),r.push(";"+Q+"="+(S?T:Co(T))))}function f(Q,T){T&&e(Q,T)}var g=a.xe,h=a.We,l=a.protocol,m=a.Ce;l+=h?"//"+g+".fls.doubleclick.net/activityi":"//ad.doubleclick.net/activity";var p=";",q=!1;
q=!0;fh(N.D)||m||!a.sa&&!q||(l="https://ade.googlesyndication.com/ddm/activity",p="/",h=!1);var r=[p,"src="+Co(g),";type="+Co(a.Be),";cat="+Co(a.$b)],t=a.Xh||{};Ua(t,function(Q,T){r.push(";"+Co(Q)+"="+Co(T+""))});if(Bo(e,a)){Ao(a.yd)&&e("u",a.yd);Ao(a.xd)&&e("tran",a.xd);e("gtm",pn());Qg()&&!m&&(e("gcs",gh()),c&&e("gcu","1"));f("gdpr_consent",Tn()),f("gdpr",Vn());
"1"===Nj(!1)._up&&e("gtm_up","1");!1===a.Lh&&e("npa","1");if(a.te){var u=void 0===a.sa?!0:!!a.sa,v=Fk("dc",a.Ea,u),w=!1;v&&v.length&&(e("gcldc",v.join(".")),w=!0);var y=!0;y=h;if(y)if(Do&&!w&&Kk(a.Ea)){var x=Fk("gb",a.Ea,u);x.length&&e("gclgb",x.join("."));var z=Ik(u);z&&e("gacgb",z)}else{var B=Fk("aw",a.Ea,u);B&&B.length&&e("gclaw",B.join("."));var C=Hk(u);C&&e("gac",C)}pj({prefix:a.Ea,
pb:a.Vh,domain:a.Uh,flags:a.lj});var E=lj[mj(a.Ea)];E&&e("auiddc",E)}Ao(a.Oe)&&e("prd",a.Oe,!0);Ao(d)&&e("em",d,!0);Ua(a.$e,function(Q,T){e(Q,T)});r.push(b||"");var D=zo();D&&r.push(";ps=1");if(Ao(a.qd)){var I=a.qd||"";fh(N.D)||m||!a.sa||(I=Fh(I));e("~oref",I)}var R=l+r.join("")+"?";h?fc(R,a.onSuccess):gc(R,a.onSuccess,a.onFailure);D&&gc("https://"+g+".fls.doubleclick.net/activityi;register_conversion=1"+
r.join("")+"?");}else J(a.onFailure)},Fo=function(a,b,c){var d=!1;d&&a.ka?ii(a.ka,[],function(e){Eo(a,b,c,e)}):Eo(a,b,c)},Do=!1;Do=!0;var Co=encodeURIComponent,yo=!1,Go=function(a,b){!Qg()||a.Ce?
Fo(a,b):jh(function(){Fo(a,b);fh(N.D)||ih(function(){Fo(a,b,!0)},N.D)},[N.D])};var bp=function(){var a=!0;Wn(7)&&Wn(9)&&Wn(10)||(a=!1);var b=!0;b=!1;b&&!ap()&&(a=!1);return a},ap=function(){var a=!0;Wn(3)&&Wn(4)||(a=!1);return a};var Bp=!1;function Cp(){var a=ji;return a.gcq=a.gcq||new Dp}
...
function lr(a,b){}function mr(a,b){return!0};function nr(a,b,c){};function or(a,b){var c;M(G(this),["path:!string"],[a]);gg(this,"access_globals","execute",a);for(var d=a.split("."),e=A,f=e[d[0]],g=1;f&&g<d.length;g++)if(e=f,f=f[d[g]],e===A||e===H)return;if("function"!==Bc(f))return;var h=!1;for(var l=[],m=1;m<arguments.length;m++)l.push(Fc(arguments[m],this.g,h));var p=(0,this.g.P)(f,e,l);
c=Ec(p,this.g);void 0===c&&void 0!==p&&yg(45);return c};function pr(a){};function qr(a){};var rr=!1,sr=[];function tr(){if(!rr){rr=!0;for(var a=0;a<sr.length;a++)J(sr[a])}}var ur=function(a){rr?J(a):sr.push(a)};function vr(a){M(G(this),["listener:!Fn"],arguments);gg(this,"process_dom_events","window","load");ur(Fc(a))};function wr(a){var b;return b};function xr(a,b){var c;var d=!1;var e=Ec(c,this.g,d);void 0===e&&void 0!==c&&yg(45);return e};function yr(a){var b;M(G(this),["path:!string"],arguments);gg(this,"access_globals","read",a);var c=a.split("."),d=jb(c,[A,H]);if(!d)return;var e=d[c[c.length-1]],f=!1;b=Ec(e,this.g,f);void 0===b&&void 0!==e&&yg(45);return b};function zr(a,b){var c=null,d=!1;M(G(this),["functionPath:!string","arrayPath:!string"],arguments);gg(this,"access_globals","readwrite",a);gg(this,"access_globals","readwrite",b);var e=[A,H],f=a.split("."),g=jb(f,e),h=f[f.length-1];if(void 0===g)throw Error("Path "+a+" does not exist.");var l=g[h];if(l&&!Ja(l))return null;
if(l)return Ec(l,this.g,d);var m;l=function(){if(!Ja(m.push))throw Error("Object at "+b+" in window is not an array.");m.push.call(m,arguments)};g[h]=l;var p=b.split("."),q=jb(p,e),r=p[p.length-1];if(void 0===q)throw Error("Path "+p+" does not exist.");m=q[r];void 0===m&&(m=[],q[r]=m);c=function(){l.apply(l,Array.prototype.slice.call(arguments,0))};return Ec(c,this.g,d)};function Ar(a){var b;M(G(this),["path:!string"],arguments);gg(this,"access_globals","readwrite",a);var c=a.split("."),d=jb(c,[A,H]),e=c[c.length-1];if(void 0===d)throw Error("Path "+a+" does not exist.");var f=d[e];void 0===f&&(f=[],d[e]=f);b=function(){if(!Ja(f.push))throw Error("Object at "+a+" in window is not an array.");f.push.apply(f,Array.prototype.slice.call(arguments,0))};var g=!1;return Ec(b,this.g,g)};var Br;function Cr(a){var b=!1;return b};var Dr=function(a){var b;return b};function Er(a,b){b=void 0===b?!0:b;var c;return c};function Fr(a){var b=null;return b};function Gr(a,b){var c;M(G(this),["queryKey:!string","retrieveAll:?boolean"],arguments);gg(this,"get_url","query",a);var d=Ch(Eh(A.location.href),"query"),e=zh(d,a,b);c=Ec(e,this.g);return c};function Hr(a,b){var c;return c};function Ir(a){var b="";return b};function Jr(a,b){var c;return c};function Kr(a){var b="";M(G(this),["component:?string"],arguments),gg(this,"get_url",a),b=Ch(Eh(A.location.href),a);return b};function Lr(){gg(this,"get_user_agent");return A.navigator.userAgent};function Mr(a,b){};var Nr={};function Or(a,b,c,d,e,f){f?e[f]?(e[f][0].push(c),e[f][1].push(d)):(e[f]=[[c],[d]],dc(a,function(){for(var g=e[f][0],h=0;h<g.length;h++)J(g[h]);g.push=function(l){J(l);return 0}},function(){for(var g=e[f][1],h=0;h<g.length;h++)J(g[h]);e[f]=null},b)):dc(a,c,d,b)}
...
function Xr(a){var b;return b};function Yr(){try{gg(this,"logging")}catch(c){return}if(!console)return;for(var a=Array.prototype.slice.call(arguments,0),b=0;b<a.length;b++)a[b]=Fc(a[b],this.g);console.log.apply(console,a);};function Zr(a,b){var c;return c};function $r(a){var b=void 0;return b};function as(a,b){var c=!1;return c};function bs(){var a="";return a};function cs(){var a="";return a};var ds=["set","get","config","event"];
...
Y.h.gaawc=["google"],function(){function a(b,c,d){for(var e=0;e<c.length;e++)b.hasOwnProperty(c[e])&&(b[c[e]]=d(b[c[e]]))}(function(b){Y.__gaawc=b;Y.__gaawc.m="gaawc";Y.__gaawc.o=!0;Y.__gaawc.priorityOverride=10})(function(b){var c=String(b.vtp_measurementId),d=Bu(b.vtp_fieldsToSet,"name","value")||{};if(d.hasOwnProperty(N.Ma)||b.vtp_userProperties){var e=d[N.Ma]||{};L(Bu(b.vtp_userProperties,"name","value"),e);d[N.Ma]=e}b.vtp_enableSendToServerContainer&&b.vtp_serverContainerUrl&&(d[N.na]=b.vtp_serverContainerUrl,
d[N.Sb]=!0);a(d,N.Kf,function(f){return Xa(f)});a(d,N.Mf,function(f){return Number(f)});d.send_page_view=b.vtp_sendPageView;Gp(d,c);J(b.vtp_gtmOnSuccess)})}();
Y.h.gaawe=["google"],function(){function a(d,e,f){for(var g=0;g<e.length;g++)d.hasOwnProperty(e[g])&&(d[e[g]]=f(d[e[g]]))}function b(d,e,f){var g={id:"transaction_id",revenue:"value",list:"item_list_name"},h={click:N.Cd,detail:N.Ia,add:N.vb,remove:N.wb,checkout:N.ab,checkout_option:"checkout_option",purchase:N.la,refund:N.xb},l={},m=function(t,u){l[t]=l[t]||u},p=function(t,u,v){v=void 0===v?!1:v;c.push(6);if(t){l.items=l.items||[];for(var w={},y=0;y<t.length;w={rb:w.rb},y++)w.rb={},Ua(t[y],function(z){return function(B,
C){v&&"id"===B?z.rb.promotion_id=C:v&&"name"===B?z.rb.promotion_name=C:z.rb[B]=C}}(w)),l.items.push(w.rb)}if(u)for(var x in u)g.hasOwnProperty(x)?m(g[x],u[x]):m(x,u[x])},q;if("dataLayer"===d.vtp_getEcommerceDataFrom){d.vtp_gtmCachedValues&&(q=d.vtp_gtmCachedValues.eventModel);q=q||Ji(d.vtp_gtmEventId,"eventModel");if(!q){d.vtp_gtmCachedValues&&
(q=d.vtp_gtmCachedValues.ecommerce);q=q||Ji(d.vtp_gtmEventId,"ecommerce")}}else q=d.vtp_ecommerceMacroData;if(Dc(q)){c.push(5);for(var r in q)q.hasOwnProperty(r)&&("currencyCode"===r?m("currency",q.currencyCode):"impressions"===r&&e===N.Gc?p(q.impressions,null):"promoClick"===r&&e===N.nf?p(q.promoClick.promotions,q.promoClick.actionField,!0):"promoView"===r&&e===N.pf?p(q.promoView.promotions,q.promoView.actionField,!0):h.hasOwnProperty(r)?e===
h[r]&&p(q[r].products,q[r].actionField):l[r]=q[r]);L(l,f)}}var c=[];(function(d){Y.__gaawe=d;Y.__gaawe.m="gaawe";Y.__gaawe.o=!0;Y.__gaawe.priorityOverride=0})(function(d){var e=String(d.vtp_measurementIdOverride||d.vtp_measurementId),f=String(d.vtp_eventName);if("_"===f.charAt(0))J(d.vtp_gtmOnFailure);else{var g={};c=[];d.vtp_sendEcommerceData&&(0<=N.Lf.indexOf(f)||"checkout_option"===f)&&b(d,f,g);var h=Bu(d.vtp_eventParameters,"name","value"),l;for(l in h)h.hasOwnProperty(l)&&(g[l]=h[l]);if(g.hasOwnProperty(N.Ma)||
d.vtp_userProperties){var m=g[N.Ma]||{};L(Bu(d.vtp_userProperties,"name","value"),m);g[N.Ma]=m}kx(g);0<c.length&&(g[N.Zd]=c);a(g,N.Kf,function(p){return Xa(p)});a(g,N.Mf,function(p){return Number(p)});Fp(f,g,e);J(d.vtp_gtmOnSuccess)}})}();

Y.h.flc=[],function(){function a(c,d){d=d?d.slice(0,-1):void 0;Go(c,d)}var b=!1;(function(c){Y.__flc=c;Y.__flc.m="flc";Y.__flc.o=!0;Y.__flc.priorityOverride=0})(function(c){var d=!c.hasOwnProperty("vtp_enableConversionLinker")||!!c.vtp_enableConversionLinker,e=Bu(c.vtp_customVariable||[],"key",
"value")||{};var p={$b:c.vtp_activityTag,te:d,Ea:c.vtp_conversionCookiePrefix||void 0,jd:void 0,qa:{UNIQUE:3,SESSION:4}[c.vtp_ordinalType]||2,xe:c.vtp_advertiserId,Be:c.vtp_groupTag,onFailure:c.vtp_gtmOnFailure,onSuccess:c.vtp_gtmOnSuccess,qd:c.vtp_useImageTag?void 0:c.vtp_url,protocol:"",Te:void 0,
We:!c.vtp_useImageTag,sessionId:c.vtp_sessionId,xd:c.vtp_transactionVariable,transactionId:void 0,yd:c.vtp_userVariable,ka:c.vtp_userDataVariable,$e:e},q=!1;var r=!(fh(N.D)||q)&&void 0!=It(N.R)&&!1!==It(N.R);p.sa=r;if(c.vtp_enableAttribution){var t=c.vtp_attributionFields||[];if(t.length){P("//www.gstatic.com/attribution/collection/attributiontools.js",
function(){a(p,V("google_attr").build([Bu(t,"key","value")||{}]))},c.vtp_gtmOnFailure);return}}a(p)})}();
...
Y.h.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=Up(c,"gtm.click");Jt(d)}}(function(b){Y.__cl=b;Y.__cl.m="cl";Y.__cl.o=!0;Y.__cl.priorityOverride=0})(function(b){if(!Ot("cl")){var c=V("document");hc(c,"click",a,!0);Pt("cl")}J(b.vtp_gtmOnSuccess)})}();Y.h.k=["google"],function(){(function(a){Y.__k=a;Y.__k.m="k";Y.__k.o=!0;Y.__k.priorityOverride=0})(function(a){return Lt(a.vtp_name,It("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();

Y.h.fls=[],function(){function a(c,d){d=d?d.slice(0,-1):void 0;Go(c,d)}var b=!1;(function(c){Y.__fls=c;Y.__fls.m="fls";Y.__fls.o=!0;Y.__fls.priorityOverride=0})(function(c){var d,e=[];if(c.vtp_enableProductReporting){var f=
function(B){B=B||[];for(var C=[],E=[["i","id"],["p","price"],["q","quantity"],["c","country"],["l","language"],["a","accountId"]],D=0;D<B.length;D++)for(var I=0;I<E.length;I++){var R=E[I],Q=B[D][R[1]];void 0!==Q&&C.push(R[0]+(D+1)+":"+W(Q))}return C.join("|")};switch(c.vtp_dataSource){case "DATA_LAYER":e=It("ecommerce.purchase.products");d=f(e);break;case "JSON":e=c.vtp_productData;d=f(e);break;case "STRING":for(var g=(c.vtp_productData||"").split("|"),h=0;h<g.length;h++){var l=g[h].split(":");l[1]=
l[1]&&W(l[1])||"";g[h]=l.join(":");}d=g.join("|")}}var m=!c.hasOwnProperty("vtp_enableConversionLinker")||!!c.vtp_enableConversionLinker,
p=Bu(c.vtp_customVariable||[],"key","value")||{};var w={$b:c.vtp_activityTag,te:m,Ea:c.vtp_conversionCookiePrefix||void 0,jd:c.vtp_revenue,qa:"ITEM_SOLD"===c.vtp_countingMethod?6:5,xe:c.vtp_advertiserId,Be:c.vtp_groupTag,onFailure:c.vtp_gtmOnFailure,onSuccess:c.vtp_gtmOnSuccess,
qd:c.vtp_useImageTag?void 0:c.vtp_url,Oe:d,protocol:"",Te:c.vtp_quantity,We:!c.vtp_useImageTag,xd:c.vtp_transactionVariable,transactionId:c.vtp_orderId,yd:c.vtp_userVariable,ka:c.vtp_userDataVariable,$e:p},y=!1;var x=!(fh(N.D)||y)&&void 0!=It(N.R)&&!1!==It(N.R);w.sa=x;if(c.vtp_enableAttribution){var z=c.vtp_attributionFields||[];if(z.length){P("//www.gstatic.com/attribution/collection/attributiontools.js",
function(){a(w,V("google_attr").build([Bu(z,"key","value")||{}]))},c.vtp_gtmOnFailure);return}}a(w)})}();
...
r+".");},T:a}})}();Y.h.r=["google"],function(){(function(a){Y.__r=a;Y.__r.m="r";Y.__r.o=!0;Y.__r.priorityOverride=0})(function(a){return Ra(a.vtp_min,a.vtp_max)})}();
...
!0,void 0!==c.vtp_cookieUpdate&&(h=!!c.vtp_cookieUpdate));var l={prefix:f,path:d,domain:e,flags:g};c.vtp_enableCrossDomainFeature&&(c.vtp_enableCrossDomain&&!1===c.vtp_acceptIncoming||(c.vtp_enableCrossDomain||Uj())&&uk(a,l));rk(l);xk(["aw","dc"],l);b?Jk(h,l):Jk(h,l,"dc");var m=f;if(c.vtp_enableCrossDomainFeature&&c.vtp_enableCrossDomain&&c.vtp_linkerDomains){var p=c.vtp_linkerDomains.toString().replace(/\s+/g,"").split(",");wk(a,p,c.vtp_urlPosition,!!c.vtp_formDecoration,m)}var q=It(N.R);Zn({qe:!1,
sa:void 0!=q&&!1!==q,hd:l,pd:!0});c.vtp_enableUrlPassthrough&&zk(["aw","dc","gb"])});}();
...
Y.h.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:Ft()}function b(f,g){hc(f,"hashchange",function(h){var l=a(h);g({source:"hashchange",state:null,url:Ht(l),S:Gt(l)})})}function c(f,g){hc(f,"popstate",function(h){var l=a(h);g({source:"popstate",state:h.state,url:Ht(l),S:Gt(l)})})}function d(f,g,h){var l=g.history,m=l[f];if(Ja(m))try{l[f]=function(p,q,r){m.apply(l,[].slice.call(arguments,0));h({source:f,state:p,url:Ht(Ft()),
S:Gt(Ft())})}}catch(p){}}function e(){var f={source:null,state:V("history").state||null,url:Ht(Ft()),S:Gt(Ft())};return function(g){var h=f,l={};l[h.source]=!0;l[g.source]=!0;if(!l.popstate||!l.hashchange||h.S!=g.S){var m={event:"gtm.historyChange","gtm.historyChangeSource":g.source,"gtm.oldUrlFragment":f.S,"gtm.newUrlFragment":g.S,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":g.state,"gtm.oldUrl":f.url,"gtm.newUrl":g.url};f=g;Jt(m)}}}(function(f){Y.__hl=f;Y.__hl.m="hl";Y.__hl.o=!0;Y.__hl.priorityOverride=
0})(function(f){var g=V("self");if(!Ot("hl")){var h=e();b(g,h);c(g,h);d("pushState",g,h);d("replaceState",g,h);Pt("hl")}J(f.vtp_gtmOnSuccess)})}();
...
(function(h){Y.__awct=h;Y.__awct.m="awct";Y.__awct.o=!0;Y.__awct.priorityOverride=0})(function(h){function l(O,ia,ta){return"DATA_LAYER"===O?It(ta):h[ia]}function m(){S("gdpr_consent",Tn()),S("gdpr",Vn());}
function p(){var O=[];return O}function q(){if(h.vtp_enableEnhancedConversion){var O;void 0===
h.vtp_dataSource?O=h.vtp_cssProvidedEnhancedConversionValue||h.vtp_enhancedConversionObject:"DATA_OBJECT"===h.vtp_dataSource?O=h.vtp_enhancedConversionObject:"INDIVIDUAL_FIELDS"===h.vtp_dataSource&&(O=h.vtp_cssProvidedEnhancedConversionValue);if(O)return{enhanced_conversions_mode:"manual",enhanced_conversions_manual_var:O}}}function r(O){function ia(){if(ya.length)try{Promise.all(ya).then(function(){c.push(I)});return}catch(nb){}c.push(I)}var ta=!0,na=[],ya=[];if(O){na=p();
if(u){var Ka={};h.vtp_conversionCookiePrefix&&(Ka.prefix=h.vtp_conversionCookiePrefix);pj(Ka);S("auid",lj[mj(Ka.prefix)])}}ta&&ia()}function t(){Rg()&&S("gcd","G1"+bh(Og));}
var u=!h.hasOwnProperty("vtp_enableConversionLinker")||!!h.vtp_enableConversionLinker,v=!!h.vtp_enableEnhancedConversions||!!h.vtp_enableEnhancedConversion;if(a){}else{Fl();var I={google_basket_transaction_type:"purchase",google_conversion_domain:"",google_conversion_id:h.vtp_conversionId,google_conversion_label:h.vtp_conversionLabel,google_conversion_value:h.vtp_conversionValue||0,google_remarketing_only:!1,onload_callback:h.vtp_gtmOnSuccess,gtm_onFailure:h.vtp_gtmOnFailure,google_gtm:pn()};I.google_gtm_experiments=
{capi:!0};h.vtp_rdp&&(I.google_restricted_data_processing=!0);void 0!=It(N.R)&&!1!==It(N.R)&&(I.google_gtm_url_processor=function(O){return O=el(O)});var R=function(O){return function(ia,ta,na){var ya=l(O,ta,na);ya&&(I[ia]=ya)}},Q=R("JSON");Q("google_conversion_currency","vtp_currencyCode");Q("google_conversion_order_id","vtp_orderId");h.vtp_enableProductReporting&&(Q=R(h.vtp_productReportingDataSource),Q("google_conversion_merchant_id","vtp_awMerchantId",
"aw_merchant_id"),Q("google_basket_feed_country","vtp_awFeedCountry","aw_feed_country"),Q("google_basket_feed_language","vtp_awFeedLanguage","aw_feed_language"),Q("google_basket_discount","vtp_discount","discount"),Q("google_conversion_items","vtp_items","items"),I.google_conversion_items&&I.google_conversion_items.map&&(I.google_conversion_items=I.google_conversion_items.map(function(O){return{value:O.price,quantity:O.quantity,item_id:O.id}})));var T=function(O,ia){(I.google_additional_params=I.google_additional_params||
{})[O]=ia},S=function(O,ia){void 0!==ia&&((I.google_additional_conversion_params=I.google_additional_conversion_params||{})[O]=ia)},X=function(O){return function(ia,ta,na,ya){var Ka=l(O,ta,na);ya(Ka)&&S(ia,Ka)}};var K=It("developer_id"),U=mb(Dc(K)?K:{});U&&S("did",U);(function(){if(!h.vtp_enableShippingData)return;S("delopc",h.vtp_deliveryPostalCode);
S("oedeld",h.vtp_estimatedDeliveryDate);S("delc",h.vtp_deliveryCountry);S("shf",h.vtp_shippingFee);if(h.vtp_enableProductReporting){var O=l(h.vtp_productReportingDataSource,"vtp_items","items");S("iedeld",gl(O))}})();h.vtp_transportUrl&&(I.google_transport_url=h.vtp_transportUrl);var ba=Ym(h.vtp_transportUrl,"/pagead/conversion_async.js");ba||(ba=-1==navigator.userAgent.toLowerCase().indexOf("firefox")?"//www.googleadservices.com/pagead/conversion_async.js":
"https://www.google.com/pagead/conversion_async.js");h.vtp_enableNewCustomerReporting&&(Q=X(h.vtp_newCustomerReportingDataSource),Q("vdnc","vtp_awNewCustomer","new_customer",function(O){return void 0!=O&&""!==O}),Q("vdltv","vtp_awCustomerLTV","customer_lifetime_value",function(O){return void 0!=O&&""!==O}));u?(h.vtp_conversionCookiePrefix&&(I.google_gcl_cookie_prefix=h.vtp_conversionCookiePrefix),I.google_read_gcl_cookie_opt_out=!1):I.google_read_gcl_cookie_opt_out=!0;"1"===Nj(!1)._up&&S("gtm_up",
"1");m();(function(){var O=!1;!Qg()||O?r(!0):jh(function(){m();var ia=fh(N.D),ta=void 0!=It(N.R)&&!1!==It(N.R),na=!1;na=!0;h.vtp_transportUrl||ia||!ta&&!na||(I.google_transport_url="https://pagead2.googlesyndication.com/");S("gcs",gh());
t();r(ia);ia||ih(function(){I=L(I);m();!h.vtp_transportUrl&&I.google_transport_url&&delete I.google_transport_url;S("gcs",gh());t();S("gcu","1");r(!0)},N.D)},[N.D])})();b||(b=!0,P(ba,g(),f(ba)))}})}();
Y.h.baut=["nonGoogleScripts"],function(){var a=!1;(function(b){Y.__baut=b;Y.__baut.m="baut";Y.__baut.o=!0;Y.__baut.priorityOverride=0})(function(b){function c(){var h=V(d);if(Array.isArray(h)){var l;try{l=Ub(V("UET"),{ti:b.vtp_tagId,q:h,tm:"gtm001"})}catch(m){}l?(A[d]=l,l.push("pageLoad"),b.vtp_gtmOnSuccess()):J(b.vtp_gtmOnFailure)}else b.vtp_gtmOnSuccess()}var d=b.vtp_uetqName||"uetq",e=V(d,[],!0);if("VARIABLE_REVENUE"==b.vtp_eventType)e.push({gv:b.vtp_goalValue}),
b.vtp_gtmOnSuccess();else if("CUSTOM"==b.vtp_eventType){var f={},g=function(h,l){void 0!==b[h]&&(f[l]=b[h])};g("vtp_goalValue","gv");g("vtp_eventCategory","ec");g("vtp_eventAction","ea");g("vtp_eventLabel","el");g("vtp_eventValue","ev");e.push(f);b.vtp_gtmOnSuccess()}else if(Array.isArray(e))if(a)c();else try{P("https://bat.bing.com/bat.js",function(){a=!0;c()},b.vtp_gtmOnFailure)}catch(h){J(b.vtp_gtmOnFailure)}else b.vtp_gtmOnSuccess()})}();
...
Y.h.hid=["google"],function(){(function(a){Y.__hid=a;Y.__hid.m="hid";Y.__hid.o=!0;Y.__hid.priorityOverride=0})(function(){return pt.Xc})}();
