...
if(c.indexOf(name)==0){return c.substring(name.length,c.length)}}
return""}
function acceptCookieConsent(){deleteCookie('user_cookie_consent');setCookie('user_cookie_consent',1,365);document.getElementById("cookieNotice").style.display="none"}
